...
export const MOCK_USERS_LIST = [
  ...
  { _id: '696a1d32e8ceec1d15098204', id: 'usr_123', name: 'Pratik Gaurav', role: 'Product Admin', email: 'pratik.gaurav@maprecruit.ai', avatar: null, initials: 'PG', color: 'bg-emerald-100 text-emerald-700' }, // Current User match
];
