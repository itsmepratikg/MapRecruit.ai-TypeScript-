...
export const ChatArea = ({
    ...
    const renderSMSMessage = (msg: Message, isUser: boolean) => (
        <div className={`mb-4 flex ${isUser ? 'justify-end' : 'justify-start'}`}>
            <div className={`max-w-[75%] flex flex-col ${isUser ? 'items-end' : 'items-start'}`}>
                ...
                <div className={`px-4 py-2.5 rounded-2xl text-sm shadow-sm ${isUser
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-slate-50/50 dark:bg-slate-900/50 relative">
            ...
            {/* Message List */}
            <div className="flex-1 overflow-y-auto p-6 custom-scrollbar bg-slate-100/50 dark:bg-slate-900/50" data-tour="talent-chat-thread">
