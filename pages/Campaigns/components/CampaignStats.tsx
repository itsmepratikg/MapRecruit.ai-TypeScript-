      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-slate-400 font-medium">{t("Active Campaigns")}</p>
          </div>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-green-600 font-medium">{t("Closed Campaigns")}</p>
          </div>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-green-600 dark:text-green-400 font-medium">{t("Archived Campaigns")}</p>
          </div>
