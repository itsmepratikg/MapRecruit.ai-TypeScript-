      ...
      <div className="h-full overflow-hidden flex flex-col">
         <div className="flex-1 overflow-y-auto custom-scrollbar p-8 lg:p-12">
            <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
               <div>
                  <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">{t("ReachOut Layouts")}</h3>
                  <p className="text-slate-500 dark:text-slate-400">{t("Customize how your workspace looks and behaves.")}</p>
               </div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        >
                           <div className="flex justify-between items-center mb-4">
                              <span className={`text-sm font-bold ${selectedLayout === 'standard' ? 'text-emerald-700 dark:text-emerald-400' : 'text-slate-700 dark:text-slate-300'}`}>{t("Standard")}</span>
                           ...
                           <p className="text-xs text-slate-500 dark:text-slate-400 mt-4 text-center">{t("Balanced view with metrics and charts.")}</p>
                        </div>
                        ...
                        >
                           <div className="flex justify-between items-center mb-4">
                              <span className={`text-sm font-bold ${selectedLayout === 'analytics' ? 'text-emerald-700 dark:text-emerald-400' : 'text-slate-700 dark:text-slate-300'}`}>{t("Data Focused")}</span>
                           ...
                           <p className="text-xs text-slate-500 dark:text-slate-400 mt-4 text-center">{t("Heavy emphasis on graphs and data tables.")}</p>
                        </div>
                        ...
                        >
                           <div className="flex justify-between items-center mb-4">
                              <span className={`text-sm font-bold ${selectedLayout === 'compact' ? 'text-emerald-700 dark:text-emerald-400' : 'text-slate-700 dark:text-slate-300'}`}>{t("Compact")}</span>
                           ...
                           <p className="text-xs text-slate-500 dark:text-slate-400 mt-4 text-center">{t("Maximized density for lists and tasks.")}</p>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div className="space-y-4">
                        <div className="flex items-center justify-between p-3 border border-slate-100 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors cursor-pointer">
                           <div className="flex items-center gap-4">
                              ...
                              <div>
                                 <p className="text-sm font-bold text-slate-700 dark:text-slate-200">{t("Comfortable")}</p>
                                 <p className="text-xs text-slate-500 dark:text-slate-400">{t("Standard spacing for better readability")}</p>
                              </div>
                           </div>
                        ...
                        <div className="flex items-center justify-between p-3 border border-slate-100 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors cursor-pointer">
                           <div className="flex items-center gap-4">
                              <div className="bg-slate-100 dark:bg-slate-600 p-2 rounded text-slate-500 dark:text-slate-300"><Monitor size={20} /></div>
                              <div>
                                 <p className="text-sm font-bold text-slate-700 dark:text-slate-200">{t("Compact")}</p>
                                 <p className="text-xs text-slate-500 dark:text-slate-400">{t("Reduced padding to fit more data")}</p>
                              </div>
                           </div>
