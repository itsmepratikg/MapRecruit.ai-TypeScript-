  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'ROLES_PERMISSIONS':
        return <div className="p-8 lg:p-12"><AccountPlaceholder title="Roles & Permissions" description="View your assigned roles and specific access rights within the platform." icon={Shield} /></div>;
      case 'AUTH_SYNC':
