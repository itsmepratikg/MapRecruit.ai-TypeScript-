...
export const CampaignDashboard = ({ campaign, activeTab, onBack }: { campaign: Campaign, activeTab: string, onBack?: () => void }) => {
  ...
  const renderContent = () => {
      if (activeTab === 'Intelligence') {
          ...
          return <SourceAIWrapper activeView={subView} />;
      }
          ...
          return <EngageAIWrapper activeView={subView} />;
      }
      else if (activeTab === 'Recommended Profiles') {
          return <Recommendations activeView="PROFILES" />;
      }
      else if (activeTab === 'Settings') {
          return <CampaignSettings campaign={campaign} />;
      }
