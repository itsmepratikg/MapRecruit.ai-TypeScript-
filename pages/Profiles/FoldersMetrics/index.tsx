            ...
            <table className="w-full text-sm text-left whitespace-nowrap">
               <thead className="bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400 font-semibold border-b border-slate-200 dark:border-slate-700">
                  <tr>
                     ...
                     <th className="px-6 py-3 text-center bg-emerald-50/50 dark:bg-emerald-900/10">Added (30d)</th>
                     <th className="px-6 py-3 text-center text-red-500">No Activity (30d)</th>
                     <th className="px-6 py-3 text-center border-l border-slate-100 dark:border-slate-700 bg-yellow-50/30 dark:bg-yellow-900/10">Pending</th>
                     <th className="px-6 py-3 text-center bg-blue-50/30 dark:bg-blue-900/10">Applicants</th>
                     <th className="px-6 py-3 text-center border-l border-slate-100 dark:border-slate-700">Employees</th>
                     <th className="px-6 py-3 text-center text-slate-400 font-normal">On Assignment</th>
                     <th className="px-6 py-3 text-center text-slate-400 font-normal">Not Assigned</th>
