...
import { INTERVIEW_TEMPLATES } from '../data';

const PLACEHOLDER_CANDIDATE = {
   location: "New York, NY",
   education: "Bachelor of Science, Georgia Southern University"
};
                  ...
                  <div>
                     ...
                     {!readOnly ? (
                        <>
                           ...
                           <textarea className="w-full p-2 border border-slate-300 dark:border-slate-600 rounded text-sm h-16 resize-none focus:ring-1 focus:ring-green-500 outline-none bg-white dark:bg-slate-700 dark:text-slate-200 custom-scrollbar" defaultValue={PLACEHOLDER_CANDIDATE.location}></textarea>
                        </>
                     ) : (
                        <p className="text-sm text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 p-3 border border-slate-200 dark:border-slate-700 rounded">{PLACEHOLDER_CANDIDATE.location}</p>
                     )}
                  </div>
                  <div>
